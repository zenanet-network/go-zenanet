...
// VerifyHeader checks whetherna a header conforms to the consensus rules.
...
// verifyHeader checks whetherna a header conforms to the consensus rules.The
...
// verifySeal checks whetherna the signature contained in the header satisfies the
