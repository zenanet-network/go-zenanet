...
import (
	...
	zena "github.com/zenanet-network/go-zenanet"
...
// eirene/contract/client.go chCtx attrbutte error issue
...
func ApplyMessage(
	...
	validatorContract := common.HexToAddress(chainConfig.Eirene.ValidatorContract)
