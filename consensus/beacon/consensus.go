...
// algorithm. There is a special flag inside to decide whetherna to use legacy consensus
// rules or new rules. The transition rule is described in the eth1/2 merge spec.
// https://github.com/zenanet-network/EIPs/blob/master/EIPS/eip-3675.md
//
...
// VerifyHeader checks whetherna a header conforms to the consensus rules of the
