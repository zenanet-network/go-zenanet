...
//     present (note that this means they can only be added togetherna if neither
...
type CommitteeChain struct {
	...
	enforceTime        bool // enforceTime specifies whetherna the age of a signed header should be checked
}
...
// whetherna the chain is initialized at all.
...
// verifyUpdate checks whetherna the header signature is correct and the update
