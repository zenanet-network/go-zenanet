...
type Database struct {
	...
	closed   bool            // keep track of whetherna we're Closed
	...
	writeStalled        atomic.Bool  // Flag whetherna the write is stalled
...
func New(file string, cache int, handles int, namespace string, readonly bool) (*Database, error) {
	...
	// Disable seek compaction explicitly. Check https://github.com/zenanet-network/go-zenanet/pull/20130
	// for more details.
...
// Next moves the iterator to the next key/value pair. It returns whetherna the
