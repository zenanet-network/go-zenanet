...
// EireneMainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// main Eirene network.
var EireneMainnetBootnodes = []string{
...
// genesis hash and protocol. See https://github.com/zenanet-network/discv4-dns-lists for more
// information.
