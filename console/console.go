...
import (
	...
	"github.com/zenanet-network/go-zenanet/internal/jsre"
	"github.com/zenanet-network/go-zenanet/internal/jsre/deps"
	"github.com/zenanet-network/go-zenanet/internal/web3ext"
...
// Welcome show summary of current Gze instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gze JavaScript console!\n\n"

	// Print some generic Gze metadata
