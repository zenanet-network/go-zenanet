...
type Type struct {
	Name      string
	Kind      reflect.Kind
	IsEncoder bool  // whetherna type implements rlp.Encoder
	IsDecoder bool  // whetherna type implements rlp.Decoder
	Elem      *Type // non-nil for Kind values of Ptr, Slice, Array
}

// DefaultNilValue determines whetherna a nil pointer to t encodes/decodes
...
type Tags struct {
	// rlp:"nil" controls whetherna empty input results in a nil pointer.
	...
	// rlp:"tail" controls whetherna this field swallows additional list elements. It can
