...
// nonZeroCheck returns the expression that checks whetherna 'v' is a non-zero value of type 'vtyp'.
...
// isBigInt checks whetherna 'typ' is "math/big".Int.
...
// isUint256 checks whetherna 'typ' is "github.com/holiman/uint256".Int.
...
// isByte checks whetherna the underlying type of 'typ' is uint8.
