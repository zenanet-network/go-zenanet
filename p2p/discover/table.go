...
// isInitDone returns whetherna the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whetherna the caller wants liveness-checked results. If
...
// The second return value reports whetherna the node's endpoint (IP/port) was updated.
