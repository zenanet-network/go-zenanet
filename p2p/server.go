...
import (
	...
	"github.com/zenanet-network/go-zenanet/p2p/discover"
	"github.com/zenanet-network/go-zenanet/p2p/enode"
	"github.com/zenanet-network/go-zenanet/p2p/enr"
...
type Config struct {
	...
	// DiscoveryV4 specifies whetherna V4 discovery should be started.
	DiscoveryV4 bool `toml:",omitempty"`

	// DiscoveryV5 specifies whetherna the new topic-discovery based V5 discovery
