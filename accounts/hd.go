...
// from https://github.com/zenanet-network/EIPs/issues/84, albeit it's not set in stone
// yet whetherna accounts should increment the last component or the children of
