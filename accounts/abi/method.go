...
const (
	...
	// This function is executed on plain Zena transfers.
	Receive
	// Function represents a normal function.
	Function
)

// Method represents a callable given a `Name` and whetherna the method is a constant.
...
type Method struct {
	...
	// Type indicates whetherna the method is a
...
// IsConstant returns the indicator whetherna the method is read-only.
func (method Method) IsConstant() bool {
	return method.StateMutability == "view" || method.StateMutability == "pure" || method.Constant
}

// IsPayable returns the indicator whetherna the method can process
// plain zena transfers.
