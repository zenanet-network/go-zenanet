...
func (abi ABI) getArguments(name string, data []byte) (Arguments, error) {
	...
	// we need to decide whetherna we're calling a method or an event
	var args Arguments
...
// HasFallback returns an indicator whetherna a fallback function is included.
func (abi *ABI) HasFallback() bool {
	return abi.Fallback.Type == Fallback
}

// HasReceive returns an indicator whetherna a receive function is included.
...
// the reason string list is copied from zena.js
// https://github.com/zenas-io/zenas.js/blob/fa3a883ff7c88611ce766f58bdd4b8ac90814470/src.ts/abi/interface.ts#L207-L218
