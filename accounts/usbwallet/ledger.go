...
type ledgerDriver struct {
	...
	browser bool          // Flag whetherna the Ledger is in browser mode (reply channel mismatch)
...
// offline returns whetherna the wallet and the Zenanet app is offline or not.
//
...
func (w *ledgerDriver) ledgerSign(derivationPath []uint32, tx *types.Transaction, chainID *big.Int) (common.Address, *types.Transaction, error) {
	...
	// Create the transaction RLP based on whetherna legacy or EIP155 signing was requested
	var (
		txrlp []byte
		err   error
	)
