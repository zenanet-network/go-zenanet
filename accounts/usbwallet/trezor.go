...
import (
	...
	"github.com/zenanet-network/go-zenanet/accounts/usbwallet/trezor"
...
type trezorDriver struct {
	...
	pinwait        bool          // Flags whetherna the device is waiting for PIN entry
	passphrasewait bool          // Flags whetherna the device is waiting for passphrase entry
...
// Status implements accounts.Wallet, always whetherna the Trezor is opened, closed
// or whetherna the Zenanet app was not started on it.
