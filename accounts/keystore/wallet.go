...
// Status implements accounts.Wallet, returning whetherna the account held by the
...
// Contains implements accounts.Wallet, returning whetherna a particular account is
