...
// usecolor defines whetherna the CLI help should use colored output or normal dumb
...
// Example:
//
//	gze account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
//	gze --keystore /tmp/mykeystore --lightkdf account new
//
