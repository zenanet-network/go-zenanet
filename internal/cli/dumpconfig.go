...
func (c *DumpconfigCommand) MarkDown() string {
	items := []string{
		"# Dumpconfig",
		"The ```eirene dumpconfig <your-favourite-flags>``` command will export the user provided flags into a configuration file",
	}
...
func (c *DumpconfigCommand) Help() string {
	return `Usage: eirene dumpconfig <your-favourite-flags>
