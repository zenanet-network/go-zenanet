...
func (c *PeersCommand) MarkDown() string {
	items := []string{
		...
		"- [```peers list```](./peers_list.md): Lists the connected peers to the Eirene client.",
...
func (c *PeersCommand) Help() string {
	return `Usage: eirene peers <subcommand>
  ...
  Add a new peer by enode:
    ...
    $ eirene peers add <enode>

  Remove a connected peer by enode:

    $ eirene peers remove <enode>

  Display information about a peer:

    $ eirene peers status <peer id>`
}
