...
func (c *Command) Flags(config *Config) *flagset.Flagset {
	...
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "eirene.logs",
		Usage:   `Enables eirene log retrieval`,
		Value:   &c.cliConfig.EireneLogs,
		Default: c.cliConfig.EireneLogs,
	})
	...
	f.StringFlag(&flagset.StringFlag{
		...
		Value:   &c.cliConfig.Harmonia.URL,
		Default: c.cliConfig.Harmonia.URL,
	})
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "eirene.withoutharmonia",
		Usage:   "Run without Harmonia service (for testing purpose)",
		Value:   &c.cliConfig.Harmonia.Without,
		Default: c.cliConfig.Harmonia.Without,
	})
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "eirene.devfakeauthor",
		Usage:   "Run miner without validator set authorization [dev mode] : Use with '--eirene.withoutharmonia'",
		Value:   &c.cliConfig.DevFakeAuthor,
		Default: c.cliConfig.DevFakeAuthor,
	})
	f.StringFlag(&flagset.StringFlag{
		Name:    "eirene.harmoniaRPC",
		Usage:   "Address of Harmonia gRPC service",
		Value:   &c.cliConfig.Harmonia.GRPCAddress,
		Default: c.cliConfig.Harmonia.GRPCAddress,
	})
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "eirene.runharmonia",
		Usage:   "Run Harmonia service as a child process",
		Value:   &c.cliConfig.Harmonia.RunHarmonia,
		Default: c.cliConfig.Harmonia.RunHarmonia,
	})
	f.StringFlag(&flagset.StringFlag{
		Name:    "eirene.runharmoniaargs",
		Usage:   "Arguments to pass to Harmonia service",
		Value:   &c.cliConfig.Harmonia.RunHarmoniaArgs,
		Default: c.cliConfig.Harmonia.RunHarmoniaArgs,
	})
	f.BoolFlag(&flagset.BoolFlag{
		Name:    "eirene.useharmoniaapp",
		Usage:   "Use child harmonia process to fetch data, Only works when eirene.runharmonia is true",
		Value:   &c.cliConfig.Harmonia.UseHarmoniaApp,
		Default: c.cliConfig.Harmonia.UseHarmoniaApp,
	})
	...
	f.BoolFlag((&flagset.BoolFlag{
		Name:    "disable-eirene-wallet",
		Usage:   "Disable the personal wallet endpoints",
		Value:   &c.cliConfig.Accounts.DisableEireneWallet,
		Default: c.cliConfig.Accounts.DisableEireneWallet,
	}))
