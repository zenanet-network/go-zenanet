...
func (d *DebugPprofCommand) MarkDown() string {
	items := []string{
		"# Debug Pprof",
		"The ```debug pprof <enode>``` command will create an archive containing eirene pprof traces.",
		d.Flags().MarkDown(),
	}
...
func (d *DebugPprofCommand) Help() string {
	return `Usage: eirene debug

  Build an archive containing eirene pprof traces
...
func (d *DebugPprofCommand) Synopsis() string {
	return "Build an archive containing Eirene pprof traces"
}
