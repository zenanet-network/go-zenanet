...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/zenanet-network/go-zenanet/issues/15628
	...
	// This configures whetherna blobs are allowed to be passed.
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/zenanet-network/go-zenanet/pull/23274
	...
	// Now attempt to fill in default value depending on whetherna London is active or not.
	if isLondon {
...
func (args *TransactionArgs) setBlobTxSidecar(ctx context.Context) error {
	...
	// blobs togetherna with commitments and proofs.
