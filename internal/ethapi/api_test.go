...
func (b testBackend) GetEireneBlockTransactionWithBlockHash(ctx context.Context, txHash common.Hash, blockHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
...
func TestCall(t *testing.T) {
	...
	var testSuite = []struct {
		...
		// EIRENE Doens't support blob tx
		// BLOBHASH opcode
		// {
		// 	blockNumber: rpc.LatestBlockNumber,
		// 	call: TransactionArgs{
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	...
	// that is commented out in eirene, we use the old genesis hash in the test files.
