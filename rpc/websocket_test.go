...
// This test checks whetherna calls exceeding the request size limit are rejected.
...
// This test checks whetherna the wsMessageSizeLimit option is obeyed.
...
func TestClientWebsocketPing(t *testing.T) {
	...
	// This is important for reproducing https://github.com/zenanet-network/go-zenanet/issues/19798
	<-ctx.Done()
	close(sendPing)
