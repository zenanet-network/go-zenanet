...
// Package gzeclient provides an RPC client for gze-specific APIs.
package gzeclient
...
// Client is a wrapper around rpc.Client that implements gze-specific functionality.
//
...
// GCStats retrieves the current garbage collection stats from a gze node.
...
// MemStats retrieves the current memory stats from a gze node.
...
// GetNodeInfo retrieves the node info of a gze node.
