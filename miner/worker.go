...
type generateParams struct {
	...
	forceTime   bool              // Flag whetherna the given timestamp is immutable or not
	...
	noTxs       bool              // Flag whetherna an empty block without any transaction is expected
}
...
func (miner *Miner) commitTransactions(env *environment, plainTxs, blobTxs *transactionsByPriceAndNonce, interrupt *atomic.Int32) error {
	...
	for {
		...
		// Check whetherna the tx is replay protected. If we're not in the EIP155 hf
