...
import (
	...
	cmath "github.com/zenanet-network/go-zenanet/common/math"
...
func (w *worker) mainLoopWithDelay(ctx context.Context, delay uint, opcodeDelay uint) {
	...
	for {
		...
		case req := <-w.newWorkCh:
			if w.chainConfig.ChainID.Cmp(params.EireneMainnetChainConfig.ChainID) == 0 || w.chainConfig.ChainID.Cmp(params.MumbaiChainConfig.ChainID) == 0 {
