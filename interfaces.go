...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whetherna the transaction has been
...
type SyncProgress struct {
	...
	// "fast sync" fields. These used to be sent by gze, but are no longer used
	// since version v1.10.
