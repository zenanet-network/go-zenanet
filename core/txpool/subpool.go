...
type SubPool interface {
	// Filter is a selector used to decide whetherna a transaction would be added
	...
	// Has returns an indicator whetherna subpool has a transaction cached with the
	// given hash.
	...
	// to a later point to batch multiple ones togetherna.
