...
func init() {
	...
	/*
		Given the introduction of `EireneDefaultTxPoolPriceLimit=25gwei`,
...
// TestTxPoolDefaultPriceLimit ensures the eirene default tx pool price limit is set correctly.
func TestTxPoolDefaultPriceLimit(t *testing.T) {
	...
	if have, want := pool.config.PriceLimit, uint64(params.EireneDefaultTxPoolPriceLimit); have != want {
