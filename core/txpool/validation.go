...
// ValidateTransaction is a helper method to check whetherna a transaction is valid
...
func ValidateTransaction(tx *types.Transaction, head *types.Header, signer types.Signer, opts *ValidationOptions) error {
	...
	// Check whetherna the init code size has been exceeded
...
// ValidateTransactionWithState is a helper method to check whetherna a transaction
