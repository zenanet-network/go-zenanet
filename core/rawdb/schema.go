...
// IsCodeKey reports whetherna the given byte slice is the key of contract code,
...
// IsLegacyTrieNode reports whetherna a provided database entry is a legacy trie
...
// ResolveAccountTrieNodeKey reports whetherna a provided database entry is an
...
// IsAccountTrieNode reports whetherna a provided database entry is an account
...
// ResolveStorageTrieNode reports whetherna a provided database entry is a storage
...
// IsStorageTrieNode reports whetherna a provided database entry is a storage
// trie node in path-based state scheme.
