...
// all index entries in the file are zero. Distinguishing whetherna they represent
...
// has returns an indicator whetherna the specified number data is still accessible
