...
// TODO:
// IsCancun issue: The chainConfig.IsCancun function expects two arguments, a big.Int and a uint64, but only one big.Int was provided when called
func (h *Header) GetValidatorBytes(chainConfig *params.ChainConfig) []byte {
	if !chainConfig.IsCancun(h.Number, h.Number.Uint64()) {
