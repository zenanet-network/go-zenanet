...
import (
	...
	"github.com/zenanet-network/go-zenanet/core/vm/program"
...
func testBlockChainImport(chain types.Blocks, blockchain *BlockChain) error {
	for _, block := range chain {
		...
		statedb, err := state.New(blockchain.GetBlockByHash(block.ParentHash()).Root(), blockchain.statedb, nil)
		if err != nil {
			return err
		}
...
//
// https://github.com/zenanet-network/go-zenanet/pull/15941
...
//
// Details at:
//   - https://github.com/zenanet-network/go-zenanet/issues/18977
//   - https://github.com/zenanet-network/go-zenanet/pull/18988
