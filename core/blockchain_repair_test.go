...
func TestShortSnapSyncedRepair(t *testing.T) {
	t.Skip("snap sync not supported in eirene")
...
// TestIssue23496 tests scenario described in https://github.com/zenanet-network/go-zenanet/pull/23496#issuecomment-926393893
