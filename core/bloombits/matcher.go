...
import (
	...
	"github.com/zenanet-network/go-zenanet/common/bitutil"
...
type Matcher struct {
	...
	running atomic.Bool // Atomic flag whetherna a session is live or not
}
...
// that address/topic, and binary AND-ing those vectors togetherna.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togetherna
				var orVector []byte
...
// the requested retrieval queue to be serviced togetherna with other sessions.
//
