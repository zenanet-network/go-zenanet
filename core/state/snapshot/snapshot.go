...
type snapshot interface {
	...
	// Stale return whetherna this layer has become stale (was flattened across) or
	// if it's still live.
	Stale() bool
...
// generating is an internal helper function which reports whetherna the snapshot
