...
type proofResult struct {
	...
	proofErr error      // Indicator whetherna the given state range is valid or not
...
// last returns the last verified element key regardless of whetherna the range proof is
