...
// It can be used for testing that restart Gze normally.
...
// It can be used for testing that restart Gze after the crash.
...
// Tests a Gze restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gze was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gze was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gze was running with snapshot enabled. Then restarts without
...
// Tests the Gze was running with snapshot enabled and resetHead is applied.
...
// Tests the Gze was running with a complete snapshot and then imports a few
