...
var flagMap = map[string][]string{
	...
	"mainnet":                          {"BoolFlag", "No"},
	"goerli":                           {"BoolFlag", "No"},
	"eirene-mumbai":                       {"BoolFlag", "No"},
	"eirene-amoy":                         {"BoolFlag", "No"},
	"eirene-mainnet":                      {"BoolFlag", "No"},
	"sepolia":                          {"BoolFlag", "No"},
...
var nameTagMap = map[string]string{
	...
	"0-snapshot":              "snapshot",
	"\"eirene.logs\"":            "eirene.logs",
	"url":                     "eirene.harmonia",
	"\"eirene.without\"":         "eirene.withoutharmonia",
	"grpc-address":            "eirene.harmoniagRPC",
	"\"eirene.runharmonia\"":     "eirene.runharmonia",
	"\"eirene.runharmoniaargs\"": "eirene.runharmoniaargs",
	...
	"lightkdf":                "lightkdf",
	"disable-eirene-wallet":      "disable-eirene-wallet",
	"addr":                    "grpc.addr",
	"dev":                     "dev",
	"period":                  "dev.period",
}
