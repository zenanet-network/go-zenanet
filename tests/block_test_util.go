...
func (t *BlockTest) Run(snapshotter bool, scheme string, witness bool, tracer *tracing.Hooks, postCheck func(error, *core.BlockChain)) (result error) {
	...
	// Import succeeded: regardless of whetherna the _test_ succeeds or not, schedule
...
/*
See https://github.com/zenanet-network/tests/wiki/Blockchain-Tests-II

	Whetherna a block is valid or not is a bit subtle, it's defined by presence of
