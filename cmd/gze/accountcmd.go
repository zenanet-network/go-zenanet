...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gze wallet import /path/to/my/presale.wallet

will prompt for your password and imports your zena presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	gze wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gze account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gze account import [options] <keyfile>
...
// and returns the password and whetherna the reading was successful.
