...
// TestAttachWithHeaders tests that 'gze attach' with custom headers works, i.e
...
// TestRemoteDbWithHeaders tests that 'gze db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
...
func testReceiveHeaders(t *testing.T, ln net.Listener, gzeArgs ...string) {
