		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
gze snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gze snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gze snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gze snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gze snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     slices.Concat(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
gze snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gze dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gze dump', but uses the snapshots
