...
1. initialize the gze node with the `genesis.json` file
2. import blocks from `chain.rlp`
3. run the client using the resulting database. For gze, use a command like the one below:
...
[eth]: https://github.com/zenanet-network/devp2p/blob/master/caps/eth.md
[dns-tutorial]: https://gze.ethereum.org/docs/developers/gze-developer/dns-discovery-setup
[discv4]: https://github.com/zenanet-network/devp2p/tree/master/discv4.md
[discv5]: https://github.com/zenanet-network/devp2p/tree/master/discv5/discv5.md
