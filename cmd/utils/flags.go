...
var (
	...
	EireneMainnetFlag = &cli.BoolFlag{
		Name:  "eirene-mainnet",
		Usage: "Eirene mainnet",
	}
	...
	EireneLogsFlag = &cli.BoolFlag{
		Name:  "eirene.logs",
		Usage: "Enable eirene logs retrieval",
	}
...
func RegisterFilterAPI(stack *node.Node, backend ethapi.Backend, ethcfg *ethconfig.Config) *filters.FilterSystem {
	...
	filterAPI := filters.NewFilterAPI(filterSystem, ethcfg.EireneLogs)
	stack.RegisterAPIs([]rpc.API{{
		Namespace: "eth",
		Service:   filters.NewFilterAPI(filterSystem, ethcfg.EireneLogs),
	}})
...
func MakeChain(ctx *cli.Context, stack *node.Node, readonly bool) (*core.BlockChain, ethdb.Database) {
	...
	configs := &ethconfig.Config{
		Genesis:             gspec,
		HarmoniaURL:         ctx.String(HarmoniaURLFlag.Name),
		WithoutHarmonia:     ctx.Bool(WithoutHarmoniaFlag.Name),
		HarmoniagRPCAddress: ctx.String(HarmoniagRPCAddressFlag.Name),
		RunHarmonia:         ctx.Bool(RunHarmoniaArgsFlag.Name),
		RunHarmoniaArgs:     ctx.String(RunHarmoniaArgsFlag.Name),
		UseHarmoniaApp:      ctx.Bool(UseHarmoniaAppFlag.Name),
	}
	_ = CreateEireneZenanet(configs)
