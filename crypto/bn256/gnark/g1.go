...
// Add adds `a` and `b` togetherna, storing the result in `g`
...
//
// Note: whetherna the deserialization is of a compressed
...
//
// This method also checks whetherna the point is on the
