...
// controls whetherna the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whetherna the signature values are valid with
