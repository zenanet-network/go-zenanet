...
type GlogHandler struct {
	...
	override atomic.Bool  // Flag whetherna overrides are used, atomically accessible
...
// Enabled implements slog.Handler, reporting whetherna the handler handles records
// at the given level.
