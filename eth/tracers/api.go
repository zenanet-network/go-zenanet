...
// containsTx reports whetherna the transaction with a certain hash
...
// along with a boolean that indicates whetherna the copy is canonical (equivalent to the original).
