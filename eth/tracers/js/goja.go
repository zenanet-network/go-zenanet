...
import (
	...
	"github.com/zenanet-network/go-zenanet/eth/tracers/internal"
	...
	jsassets "github.com/zenanet-network/go-zenanet/eth/tracers/js/internal/tracers"
)
...
// `enter` and `exit` always go togetherna.
