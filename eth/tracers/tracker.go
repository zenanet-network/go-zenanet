...
// used trace states, and to determine whetherna the creation of trace state needs
...
type stateTracker struct {
	...
	used     []bool             // List of flags indicating whetherna the trace state has been used up
