...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.HarmoniaURL = c.HarmoniaURL
	enc.WithoutHarmonia = c.WithoutHarmonia
	enc.HarmoniagRPCAddress = c.HarmoniagRPCAddress
	enc.RunHarmonia = c.RunHarmonia
	enc.RunHarmoniaArgs = c.RunHarmoniaArgs
	enc.UseHarmoniaApp = c.UseHarmoniaApp
	enc.EireneLogs = c.EireneLogs
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.HarmoniaURL != nil {
		c.HarmoniaURL = *dec.HarmoniaURL
	}
	if dec.WithoutHarmonia != nil {
		c.WithoutHarmonia = *dec.WithoutHarmonia
	}
	if dec.HarmoniagRPCAddress != nil {
		c.HarmoniagRPCAddress = *dec.HarmoniagRPCAddress
	}
	if dec.RunHarmonia != nil {
		c.RunHarmonia = *dec.RunHarmonia
	}
	if dec.RunHarmoniaArgs != nil {
		c.RunHarmoniaArgs = *dec.RunHarmoniaArgs
	}
	if dec.UseHarmoniaApp != nil {
		c.UseHarmoniaApp = *dec.UseHarmoniaApp
	}
	if dec.EireneLogs != nil {
		c.EireneLogs = *dec.EireneLogs
	}
