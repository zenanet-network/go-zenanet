...
import (
	...
	common "github.com/zenanet-network/go-zenanet/common"
	core "github.com/zenanet-network/go-zenanet/core"
	bloombits "github.com/zenanet-network/go-zenanet/core/bloombits"
	...
	ethdb "github.com/zenanet-network/go-zenanet/ethdb"
	event "github.com/zenanet-network/go-zenanet/event"
	"github.com/zenanet-network/go-zenanet/params"
	rpc "github.com/zenanet-network/go-zenanet/rpc"
)
...
func (b *TestBackend) GetEireneBlockReceipt(ctx context.Context, hash common.Hash) (*types.Receipt, error) {
	...
	receipt := rawdb.ReadEireneReceipt(b.DB, hash, *number, nil)
	if receipt == nil {
		return &types.Receipt{}, nil
	}
