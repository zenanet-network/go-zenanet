...
func NewBorBlockLogsRangeFilter(backend Backend, borConfig *params.EireneConfig, begin, end int64, addresses []common.Address, topics [][]common.Hash) *EireneBlockLogsFilter {
...
func NewBorBlockLogsFilter(backend Backend, borConfig *params.EireneConfig, block common.Hash, addresses []common.Address, topics [][]common.Hash) *EireneBlockLogsFilter {
...
func newBorBlockLogsFilter(backend Backend, eireneConfig *params.EireneConfig, addresses []common.Address, topics [][]common.Hash) *EireneBlockLogsFilter {
