...
// TestPendingTxFilter tests whetherna pending tx filters retrieve all pending transactions that are posted to the event mux.
...
// TestPendingTxFilterFullTx tests whetherna pending tx filters retrieve all pending transactions that are posted to the event mux.
...
// TestLogFilterCreation test whetherna a given filter criteria makes sense.
...
// TestInvalidLogFilterCreation tests whetherna invalid filter log criteria results in an error
...
// TestLogFilter tests whetherna log filters match the correct logs that are posted to the event feed.
