...
// in terms of reorgs. We won't reorg beyond the last eirene checkpoint submitted to mainchain and last milestone voted in the harmonia
...
func isValidPeer(fetchHeadersByNumber func(number uint64, amount int, skip int, reverse bool) ([]*types.Header, []common.Hash, error), doExist bool, number uint64, hash common.Hash) (bool, error) {
	...
	// This can be also be empty if our harmonia is not responding
