Name "gze ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/zenanet-network/go-zenanet/issues"
!define UPDATEURL "https://github.com/zenanet-network/go-zenanet/releases"
!define ABOUTURL "https://github.com/zenanet-network/go-zenanet#zenanet-go"
...
Section "Gze" GZE_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gze.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gze.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gze incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gze outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gze UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gze incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gze.exe" "" "" "Zenanet" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gze outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gze.exe" "" "" "Zenanet" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gze UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gze.exe" "" "" "Zenanet" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/zenanet-network/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ZENANET_SOCKET" "R" "HKLM" "\\.\pipe\gze.ipc"
  ${EnvVarUpdate} $0 "ZENANET_SOCKET" "A" "HKLM" "\\.\pipe\gze.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GZE_IDX}
    SectionGetSize ${GZE_IDX} $0
