...
// Tests whetherna a Lifecycle can be registered.
...
// Tests whetherna a service's protocols can be registered properly on the node's p2p server.
...
// Tests whetherna a handler can be successfully mounted on the canonical HTTP server
// on the given prefix
...
// Tests whetherna websocket requests can be handled on the same port as a regular http server.
