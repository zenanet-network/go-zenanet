...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gze.ipc", false, filepath.Join(os.TempDir(), "gze.ipc")},
		{"data", "gze.ipc", false, "data/gze.ipc"},
		{"data", "./gze.ipc", false, "./gze.ipc"},
		{"data", "/gze.ipc", false, "/gze.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gze.ipc", true, `\\.\pipe\gze.ipc`},
		{"data", "gze.ipc", true, `\\.\pipe\gze.ipc`},
		{"data", `\\.\pipe\gze.ipc`, true, `\\.\pipe\gze.ipc`},
	}
