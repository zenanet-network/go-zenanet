...
// 'terminator' byte of value 0x10 which indicates whetherna or not the node at the key
...
// the second-lowest encoding whetherna the node at the key is a value node. The low nibble
...
// hasTerm returns whetherna a hex key has the terminator flag.
