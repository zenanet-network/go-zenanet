...
// hasRightElement returns the indicator whetherna there exists more elements
...
// VerifyRangeProof checks whetherna the given leaf nodes and edge proof
...
// also return a flag to indicate whetherna there exists more accounts/slots in the trie.
//
