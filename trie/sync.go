...
// valid checks whetherna the node operation is valid.
...
func (s *Sync) AddSubTrie(root common.Hash, path []byte, parent common.Hash, parentPath []byte, callback LeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togetherna
...
func (s *Sync) children(req *nodeRequest, object node) ([]*nodeRequest, error) {
	// Gather all the children of the node, irrelevant whetherna known or not
...
// hasNode reports whetherna the specified trie node is present in the database.
